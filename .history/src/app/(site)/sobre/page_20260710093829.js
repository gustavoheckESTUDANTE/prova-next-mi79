        ...
        <section className="border-b border-slate-200 bg-slate-50">
            <div className="mx-auto grid max-w-6xl gap-8 px-4 py-16 md:grid-cols-[1.25fr_0.75fr] md:items-center">
                ...
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
                    <Image src="/img/placeholder-curso.jpg" width={300} height={300} alt="Ambiente industrial com operador trabalhando em máquina" className="h-72 w-full object-cover"></Image>
                </div>
            </div>
        </section>
