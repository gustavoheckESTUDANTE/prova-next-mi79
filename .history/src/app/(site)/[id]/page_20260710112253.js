                ...
                <div className="mt-8 grid gap-8 md:grid-cols-[1.35fr_0.65fr]">
                    <div>
                        ...
                        <div className="mt-6 flex flex-wrap gap-2 text-xs font-bold text-slate-600">
                            ...
                            <span className="rounded-full bg-white px-3 py-1">{dataFormatada}</span>
                    ...
                    <aside className="rounded-2xl border border-slate-200 bg-white p-6">
                        ...
                        <Button href={"/"} color={"blue"} className="mt-6 inline-flex rounded-full bg-weg-blue px-5 py-3 text-sm font-bold text-white h">Tenho interesse</Button>
                    </aside>
                </div>
            </div>
        </section>
