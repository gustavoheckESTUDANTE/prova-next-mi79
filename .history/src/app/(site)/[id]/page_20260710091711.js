...
export default async function userLoaded({ params }) {
    ...
    const precoFormatado = new Intl.NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(number,
        )
            ...
            <div className="mx-auto max-w-6xl px-4 py-12">
                ...
                <div className="mt-8 grid gap-8 md:grid-cols-[1.35fr_0.65fr]">
                    ...
                    <aside className="rounded-2xl border border-slate-200 bg-white p-6">
                        ...
                        <p className="mt-5 text-3xl font-extrabold tracking-tight text-weg-dark">{curso.preco}</p>
