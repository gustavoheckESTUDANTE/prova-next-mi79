                ...
                <div className="mt-8 grid gap-8 md:grid-cols-[1.35fr_0.65fr]">
                    <div>
                        ...
                        <div className="mt-6 flex flex-wrap gap-2 text-xs font-bold text-slate-600">
                            ...
                            <span className={"rounded-full px-3 py-1 " + + (curso.vagas_disponiveis > 10 ? "bg-slate-100" : "bg-amber-50 text-amber-700")}>{curso.vagas_disponiveis} vagas disponíveis</span>
                        </div>
                    </div>
