export default function Footer({ href, color }) {
    ...
    return <>
        <a href={href} className={"rounded-full px-5 py-3 text-sm font-bold " + b}>Explorar cursos</a>
        <a href="sobre" className={"rounded-full px-5 py-3 text-sm font-bold " + b}>Conhecer a WEG</a>
    </>
}