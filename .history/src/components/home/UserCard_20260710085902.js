    ...
    return <>
        <footer className="border-t border-slate-200 bg-white">
            <article class="overflow-hidden rounded-2xl border border-slate-200 bg-white">
                <Image src="/public/img/placeholder-curso.jpg" width={200} height={200} alt={`Imagem placeholder do curso ${curso.nome}`} class="h-44 w-full object-cover"></Image>
                    <div class="p-5">
                        ...
                        <a href={`/${curso.}`} class="mt-5 inline-flex text-sm font-extrabold text-weg-blue hover:text-weg-dark">Ver detalhes</a>
                    </div>
            </article>
        </footer>
    </>
